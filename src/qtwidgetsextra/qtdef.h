#pragma once
#include <QObject>
#include "qtwidgetsextra/qtwidgetsextra.h"

#define Q_BEGIN_ENUM_CREATE(CLASS)                                                                 \
    class QTWIDGETSEXTRA_EXPORT CLASS : public QObject                                             \
    {                                                                                              \
        Q_OBJECT                                                                                   \
    public:
...
Q_BEGIN_ENUM_CREATE(QtApplicationType)
...
Q_END_ENUM_CREATE(QtApplicationType)

Q_BEGIN_ENUM_CREATE(QtThemeType)
enum ThemeMode
{
    Light = 0x0000,
    Dark = 0x0001,
...
Q_END_ENUM_CREATE(QtThemeType)

Q_BEGIN_ENUM_CREATE(QtAppBarType)
enum ButtonType
{
...
Q_END_ENUM_CREATE(QtAppBarType)
Q_DECLARE_OPERATORS_FOR_FLAGS(QtAppBarType::ButtonFlags)
Q_DECLARE_OPERATORS_FOR_FLAGS(QtAppBarType::WMMouseActionTypes)

Q_BEGIN_ENUM_CREATE(QtTextType)
enum TextStyle
{
    NoStyle = 0x0000,
    Caption = 0x0001,
...
Q_END_ENUM_CREATE(QtTextType)

Q_BEGIN_ENUM_CREATE(QtNavigationType)
enum NodeResult
{
    Success = 0x0000,
...
Q_END_ENUM_CREATE(QtNavigationType)

Q_BEGIN_ENUM_CREATE(QtActionCommanderType)
enum CommanderState
{
    UndoValid = 0x0000,
    UndoInvalid = 0x0001,
...
Q_END_ENUM_CREATE(QtActionCommanderType)

Q_BEGIN_ENUM_CREATE(QtEventBusType)
...
Q_END_ENUM_CREATE(QtEventBusType)

Q_BEGIN_ENUM_CREATE(QtCardPixType)
enum PixMode
{
    Default = 0x0000,
    RoundedRect = 0x0001,
...
Q_END_ENUM_CREATE(QtCardPixType)

Q_BEGIN_ENUM_CREATE(QtGraphicsSceneType)
enum SceneMode
{
    Default = 0x0000,
    DragMove = 0x0001,
...
Q_END_ENUM_CREATE(QtGraphicsSceneType)

Q_BEGIN_ENUM_CREATE(QtMessageBarType)
enum PositionPolicy
{
    Top = 0x0000,
    Left = 0x0001,
...
Q_END_ENUM_CREATE(QtMessageBarType)

Q_BEGIN_ENUM_CREATE(QtProgressRingType)
...
Q_END_ENUM_CREATE(QtProgressRingType)

Q_BEGIN_ENUM_CREATE(QtWindowType)
...
Q_END_ENUM_CREATE(QtWindowType)

Q_BEGIN_ENUM_CREATE(QtSpinBoxType)
enum ButtonMode
{
    Inline = 0x0000,
    Compact = 0x0001,
...
Q_END_ENUM_CREATE(QtSpinBoxType)

Q_BEGIN_ENUM_CREATE(QtIconType)
enum IconName
{
    None = 0x0,
    Broom = 0xe800,
